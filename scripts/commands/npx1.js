...
const media = (
	...
	if (body.indexOf("🐰")==0 || body.indexOf("😈")==0 || body.indexOf("!random")==0 || body.indexOf("👿")==0 || body.indexOf("🤧")==0 || body.indexOf("🥵")==0 || body.indexOf("😎")==0 || body.indexOf("🤒")==0 || body.indexOf("😴")==0 || body.indexOf("😪")==0) {
		var msg = {
				body: "🖤🥀",
				attachment: media
			}
