...
(event.body.toLowerCase() == "Bot love u")) {
     return api.sendMessage("বস 🅢🅐🅝🅣🅞 মেয়েদে'র সাথে কথা বলতে মানা করছে-🙂🤗🐸", threadID);
   };

    if ((event.body.toLowerCase() == "bot jamay dau") || (event.body.toLowerCase() == "Bot jamay dau") ||
(event.body.toLowerCase() == "বট জামাই দাও")) {
     return api.sendMessage("আমার বস শান্ত  কে চোখে দেখো না নাকি__😒🥱", threadID);
   };
   
    if ((event.body.toLowerCase() == "I love you bot") || (event.body.toLowerCase() == "Bot i love you")) {
     return api.sendMessage("আমাকে না আমার বস 🅢🅐🅝🅣🅞 কে ভালোবাসো-😻🤗🌺", threadID)
   };
...
(event.body.toLowerCase() == "Chup thak")) {
     return api.sendMessage("-না আমি চুপ থাকবো না-😼-বস 🅢🅐🅝🅣🅞 আমারে কথা বলতে বলছে-🥱🥷", threadID);
   };

   if ((event.body.toLowerCase() == "চুম্মাহ দাও") || (event.body.toLowerCase() == "kiss me")) {
     return api.sendMessage("️-আমি দিবো না-😏-বস 🅢🅐🅝🅣🅞 কে বলো চু'মু দিতে-🫣🐸", threadID);
   };
  
   if ((event.body.toLowerCase() == "bot ar bacca") || (event.body.toLowerCase() == "বট এর বাচ্ছা") ||
      (event.body.toLowerCase() == "Bot er bacca")) {
     return api.sendMessage("উফফ-🥵-ঝাং-🤤-আমার বস 🅢🅐🅝🅣🅞 এর বাচ্ছা তো তোমার পেটে-🥱💦", threadID);
   };
...
(event.body.toLowerCase() == "Bow ki")) {
   ...
   if ((event.body.toLowerCase() == "তোর বানাইছে কে") || (event.body.toLowerCase() == "এটা কার বট")) {
     return api.sendMessage("️আমার বস 🅢🅐🅝🅣🅞 আমাকে শুধুমাত্র আপনাদের কে বিনোদনের জন্য তৈরি করেছেন__😊😌", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "শান্ত") || (event.body.toLowerCase() == "SANTO") || (event.body.toLowerCase() == "Santo") || (event.body.toLowerCase() == "santo")) {
     return api.sendMessage("👉আমার বস♻️  🅢🅐🅝🅣🅞 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো ‎‎‎‎‎‎‎‎‎https://www.facebook.com/share/19y3Uk7Lrz/ 🔰                                        ♪√বস ফ্রি হলে আসবে 🧡😁😜🐒",threadID);

       
   };

   if ((event.body.toLowerCase() == "/owner") || (event.body.toLowerCase() == "/Owner")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞🅢🅐🅝🅣🅞☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 🅢🅐🅝🅣🅞.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤-https://www.facebook.com/share/19y3Uk7Lrz/\nতার সাতে যোগা যোগ করবেন WhatsApp :- 01331815020", threadID);
   };

   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "tor boss ke")) {
     return api.sendMessage("My Creator:🅢🅐🅝🅣🅞 ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস 🅢🅐🅝🅣🅞 আমাকে আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য/n আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is 𝙼𝚁.𝙱𝙾𝚂𝚂 🅢🅐🅝🅣🅞 ❤️/n তাকে সবাই 🅢🅐🅝🅣🅞 নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "arushi") || (event.body.toLowerCase() == "ARUSHI")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 🅢🅐🅝🅣🅞 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  
  if ((event.body.toLowerCase() == "Arushi") || (event.body.toLowerCase() == "আরুশি")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস 🅢🅐🅝🅣🅞 এর বউ এর নাম..!😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "lima") || (event.body.toLowerCase() == "Lima")) {
     return api.sendMessage("বাড়িতে খাই ঝাটার বাড়ি, ফেসবুকে সে অ্যাটিটিউড নারী,😒🤣", threadID);
   };

  if ((event.body.toLowerCase() == "Sakib") || (event.body.toLowerCase() == "sakib")) {
     return api.sendMessage("🥰-সাকিব🌺 আমার বস 🅢🅐🅝🅣🅞 এর কলিজার বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "দন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে পারলে আমার বস শান্ত  কে গার্লফ্রেন্ড টা দিয়ে দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "Name ki") || (event.body.toLowerCase() == "name ki") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>👅-𝙼𝚁.𝙱𝙾𝚂𝚂 🅢🅐🅝🅣🅞 🎀 🍒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "gf daw bot") || (event.body.toLowerCase() == "bf daw bot")) {
     return api.sendMessage("খালি কি তোরাই পেম করবি আমার বস শান্ত  কেউ একটা gf দে<🔪😒", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("-এত ভালোবাসা কই পাও আমার বস 🅢🅐🅝🅣🅞 কে একটু দাও-!!😒😌                                                                                                              👉{https://www.facebook.com/share/19y3Uk7Lrz/}♻️✔️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "i love you") || (event.body.toLowerCase() == "Love you") || (event.body.toLowerCase() == "I Love You") || (event.body.toLowerCase() == "ভালোবাসি") || (event.body.toLowerCase() == "i love you")) {
     return api.sendMessage("হুম আমার বস 🅢🅐🅝🅣🅞 ও তেমাকে ভালোবাসে🥰🥱", threadID);
   };
     ...
     return api.sendMessage("কিরে তুই কই যাস পারলে আমার বস 🅢🅐🅝🅣🅞 এর চিপায় যা..!🌚🌶️🍆⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "ami tor boss") || (event.body.toLowerCase() == "Ami tor boss")) {
     return api.sendMessage("হ্যা 🅢🅐🅝🅣🅞 স্যার কেমন আছেন..?☺️", threadID);
   };
  
   if ((event.body.toLowerCase() == "Bye") || (event.body.toLowerCase() == "bye")) {
     return api.sendMessage("️বাই তো বললে সোজা অফলাইনে যাও অন্য কারো ইনবক্সে যেও না গেলে আমার বস্ _🅢🅐🅝🅣🅞 এর_ ইনবক্সে যাও", threadID);
   };

   if ((event.body.toLowerCase() == "লিমা") || (event.body.toLowerCase() == "LIMA")) {
     return api.sendMessage("️বাড়িতে খাই ঝাটার বাড়ি, ফেসবুকে সে অ্যাটিটিউড নারী,😒🤣", threadID);
   };

   if ((event.body.toLowerCase() == "bow daw bot") || (event.body.toLowerCase() == "Bow daw bot")) {
     return api.sendMessage("️️যেখানে আমার BOSS 🅢🅐🅝🅣🅞 সিংগেল,😼সেখানে তোগু বউ দিয়া তো বিলাসিতা,😤সর সাইডে চাপ, 😼🔪😤", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bot jamay daw") || (event.body.toLowerCase() == "Bot jamay daw")) {
     return api.sendMessage("আমার বস 🅢🅐🅝🅣🅞 কে চোখে দেখো না নাকি__😒🥱", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "অপমা") || (event.body.toLowerCase() == "opoma")) {
     return api.sendMessage("ইস তোদের নিয়ে আর পারলাম না, 🫵🏻😼এতক্ষণ বট বট করে, 😒😼.                   এখন আবার অপমা ম্যাডাম কে ডাকস,🤦🏻পারলে অপমা ম্যাডাম কে একটা বিএফ খুঁজে দে, 🔪😼", threadID);
   };

   if ((event.body.toLowerCase() == "Opoma") || (event.body.toLowerCase() == "OPOMA")) {
     return api.sendMessage("ইস তোদের নিয়ে আর পারলাম না, 🫵🏻😼এতক্ষণ বট বট করে, 😒😼.                   এখন আবার অপমা ম্যাডাম কে ডাকস,🤦🏻পারলে অপমা ম্যাডাম কে একটা বিএফ খুঁজে দে, 🔪😼", threadID);
   };

   if ((event.body.toLowerCase() == "Saifa") || (event.body.toLowerCase() == "saifa")) {
     return api.sendMessage("বাড়িতে খাই ঝাটার বাড়ি, ফেসবুকে সে অ্যাটিটিউড নারী,😒🤣", threadID);
   };
