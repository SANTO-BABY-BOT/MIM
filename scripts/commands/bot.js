...
(event.body.toLowerCase() == "Bow ki")) {
  ...
  if ((event.body.toLowerCase() == "শান্ত " || (event.body.toLowerCase() == "SANTO") || (event.body.toLowerCase() == "Santo") || (event.body.toLowerCase() == "santo")) {
     return api.sendMessage("👉আমার বস♻️ 🅢🅐🅝🅣🅞 এখন বিজি আছে । তার ইনবক্সে এ মেসেজ দিয়ে রাখো ‎‎‎‎‎‎‎‎‎https://www.facebook.com/share/1BsHoKQ3Ud/🔰                                        ♪√বস ফ্রি হলে আসবে 🧡😁😜🐒",threadID);

       
   };

   if ((event.body.toLowerCase() == "/owner") || (event.body.toLowerCase() == "/Owner")) {
     return api.sendMessage("‎[𝐎𝐖𝐍𝐄𝐑:☞𝐌𝐑.𝐁𝐎𝐒𝐒 🅢🅐🅝🅣🅞☜\n𝚈𝚘𝚞 𝙲𝚊𝚗 𝙲𝚊𝚕𝚕 𝙷𝚒𝚖 🅢🅐🅝🅣🅞.\n𝐇𝐢𝐬 𝐅𝐚𝐜𝐞𝐛𝐨𝐨𝐤 𝐋𝐢𝐧𝐤-https://www.facebook.com/share/1BsHoKQ3Ud/\nতার সাতে যোগা যোগ করবেন WhatsApp :- 01331815020", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "arushi") || (event.body.toLowerCase() == "ARUSHI")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস শান্ত   এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Hasan") || (event.body.toLowerCase() == "hasan")) {
     return api.sendMessage("🥰-হাসান🌺 আমার বস 🅢🅐🅝🅣🅞 এর কলিজার বন্ধু লাগে লুচ্ছি বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("-এত ভালোবাসা কই পাও আমার বস শান্ত  কে একটু দাও-!!😒😌                                                                                                              👉{https://www.facebook.com/share/1BsHoKQ3Ud/}♻️✔️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "bow daw bot") || (event.body.toLowerCase() == "Bow daw bot")) {
     return api.sendMessage("️️যেখানে আমার BOSS শান্ত  সিংগেল,😼সেখানে তোগু বউ দিয়া তো বিলাসিতা,😤সর সাইডে চাপ, 😼🔪😤", threadID);
   };
